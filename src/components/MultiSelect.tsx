            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute z-50 mt-2 w-64 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-xl overflow-hidden right-0"
                    >
